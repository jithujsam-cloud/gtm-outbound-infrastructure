...
import { LayoutGrid, Eye, PlusCircle } from 'lucide-react';
        ...
        <nav className="flex flex-1 flex-col px-3 mt-4">
          <div className="space-y-1">
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg px-4 py-2.5 text-on-primary/70 hover:text-on-primary transition-all active:scale-[0.98]"
            >
              <PlusCircle size={20} className="flex-shrink-0" />
              <span className="text-[15px]">Add New Client</span>
            </button>
